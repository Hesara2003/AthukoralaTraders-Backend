...
const BentoGrid = ({ children, className, ...props }) => {
  return (
    <div
      className={cn(
        "grid w-full grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-fr",
        className
      )}
      {...props}
    >
...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // dark styles
      "dark:bg-gray-900 transform-gpu dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] dark:[border:1px_solid_rgba(255,255,255,.1)]",
      className
    )}
    {...props}
  >
    ...
    <div className="relative z-10 p-6">
      <div className="pointer-events-none flex transform-gpu flex-col gap-2 transition-all duration-300 lg:group-hover:-translate-y-10">
